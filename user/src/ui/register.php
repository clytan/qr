                                        ...
                                        <form name="registerForm" id='register_form' class="form-border" method="post"
                                            ...
                                            <div class="field-set">
                                                <input type='text' name='full_name' id='full_name'
                                                    placeholder="👤 Full Name (e.g., John D Smith)" class="form-input" required>
                                            ...
                                            <div class="field-set" style="margin-top:20px;">
                                                <div style="background: rgba(255, 255, 255, 0.05); padding: 15px; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1);">
                                                    <label style="display: flex; align-items: center; cursor: pointer; font-size: 13px; color: #b0b0b0; line-height: 1.6;">
                                                        <input type="checkbox" id="terms-checkbox" required style="margin-right: 10px; min-width: 20px; width: 20px; height: 20px; cursor: pointer; flex-shrink: 0; accent-color: #8364e2; -webkit-appearance: auto; appearance: auto;">
                                                        <span>I agree to the <a href="terms.php" target="_blank" style="color: #8364e2; text-decoration: underline;" onclick="event.stopPropagation();">Terms & Conditions</a>, <a href="privacy.php" target="_blank" style="color: #8364e2; text-decoration: underline;" onclick="event.stopPropagation();">Privacy Policy</a> and <a href="refund.php" target="_blank" style="color: #8364e2; text-decoration: underline;" onclick="event.stopPropagation();">Refund Policy</a></span>
                                                    </label>
                                                </div>
                                            </div>
