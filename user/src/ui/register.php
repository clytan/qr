							...
							<div class="row align-items-center">
								...
								<div class="col-lg-4 offset-lg-2 wow fadeIn" data-wow-delay=".5s">
									<div class="box-rounded padding40" data-bgcolor="#ffffff">
                                        ...
                                        <form name="registerForm" id='register_form' class="form-border" method="post" action=''>
                                            ...
                                            <div class="field-set" style="margin-bottom:10%;">
                                                ...
                                                <div style="display:flex;gap:10px;flex-wrap:wrap;">
                                                    <label><input type="radio" name="user_type" value="1" required> Individual</label>
                                                    <label><input type="radio" name="user_type" value="2"> Creator</label>
                                                    <label><input type="radio" name="user_type" value="3"> Business</label>
                                                    <label><input type="radio" name="user_type" value="1" data-tag="gold"> <span style="color:gold;font-weight:bold;">Gold Member</span></label>
                                                    <label><input type="radio" name="user_type" value="1" data-tag="silver" ><span style="color:silver;font-weight:bold;">Silver Member</span></label>
                                                </div>
                                            </div>
                                        ...
                                        <!-- Email OTP Modal -->
                                        <div id="email-otp-modal" class="modal" tabindex="-1" role="dialog" style="display:none; background:rgba(0,0,0,0.5); position:fixed; top:0; left:0; width:100vw; height:100vh; z-index:9999; align-items:center; justify-content:center;">
                                            <div class="modal-dialog" role="document" style="max-width:400px; margin:auto;">
                                                <div class="modal-content" style="padding:30px; border-radius:8px;">
                                                    <div class="modal-header" style="border:none;">
                                                        <h5 class="modal-title">Verify Email</h5>
                                                        <button type="button" class="close" id="close-otp-modal" style="background:none; border:none; font-size:24px;">&times;</button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>An OTP has been sent to <span id="otp-email-display"></span></p>
                                                        <input type="text" id="email-otp-input" maxlength="6" class="form-control" placeholder="Enter 6-digit OTP" style="margin-bottom:10px;">
                                                        <button type="button" id="submit-otp-btn" class="btn btn-main btn-fullwidth color-2" style="margin-bottom:10px;">Verify OTP</button>
                                                        <button type="button" id="resend-otp-btn" class="btn btn-secondary btn-fullwidth">Resend OTP</button>
                                                        <div id="otp-status-msg" style="margin-top:10px; color:red;"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
