...
{
    try {
        // Note: DO NOT start a new transaction here - caller might already be in one
        // Just log if we're in a transaction
        ...
        error_log("Updated user $user_id: community_id = $community_id");
        ...
        // Don't rollback here - caller manages transaction
