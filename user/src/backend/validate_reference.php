...
try {
    ...
    $sql = "SELECT id, user_qr_id, email, first_name, last_name, created_on 
            FROM user_user 
    ...
    if ($result->num_rows > 0) {
        ...
        echo json_encode([
            ...
            'data' => [
                ...
                'referred_by_email' => $user_data['email'],
                'referred_by_name' => trim($user_data['first_name'] . ' ' . $user_data['last_name']),
