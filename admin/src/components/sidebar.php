<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="./manage_users.php" class aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a href="./slab_change.php" class aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_113_177)">
                                <path
                    ...
                    <span class="nav-text">Slab Change Request</span>
                </a>
            </li>
             <li><a href="./orders.php" class aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_113_177)">
                                <path
            ...
            <li><a href="./manage_permission.php" class aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_113_177)">
                                <path
                    ...
                    <span class="nav-text">Manage Permission</span>
                </a>
            </li>
        </ul>
    </div>
