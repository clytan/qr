...
<body>
                    ...
                    <div class="banners-grid">
                        <div class="banner-card">
                            ...
                            <div class="banner-description">
                                Create compelling collaboration requests with detailed product information and
                        ...
                        <div class="banner-card">
                            ...
                            <div class="banner-description">
                                Top influencers review your requests and choose collaborations that align with their
                                brand and audience.
                            </div>
                        </div>
                        <div class="banner-card">
                            ...
                            <div class="banner-description">
                                Track active collaborations, measure results, and build long-term partnerships that
                                drive real growth.
                            </div>
                        </div>
                    </div>
                ...
                <div class="banners-section">
                    <div class="banners-grid">
                        <div class="banner-card">
                            ...
                            <div class="banner-description">
                                Your active collaborations represent genuine partnerships with influential content
                                creators.
                            </div>
                        </div>
                        <div class="banner-card">
                ...
                <div class="banners-section">
                    <div class="banners-grid">
                        <div class="banner-card">
                            ...
                            <div class="banner-description">
                                Review your completed collaborations and celebrate successful campaigns that drove
                                results.
                            </div>
                        </div>
                        <div class="banner-card">
        ...
        <div class="modal">
            ...
            <form id="createCollabForm" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="collab_title" required
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-textarea" name="product_description" required
                        placeholder="Describe your product and what makes it special..."></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label">Product/Campaign Link</label>
                    <input type="url" class="form-input" name="product_link"
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload-area">
                        <label class="file-upload-box" for="photo1">
                            ...
                            <input type="file" id="photo1" name="product_photo_1" accept="image/*"
                        ...
                        <label class="file-upload-box" for="photo2">
                            ...
                            <input type="file" id="photo2" name="product_photo_2" accept="image/*"
                        ...
                        <label class="file-upload-box" for="photo3">
                            ...
                            <input type="file" id="photo3" name="product_photo_3" accept="image/*"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-textarea" name="detailed_summary" required
                        placeholder="Provide detailed requirements, deliverables, timeline, and any other important information..."></textarea>
                </div>
    ...
    function showTab(tab) {
        ...
        $(`.tab-btn:contains('${tab === 'pending' ? 'Pending' : tab === 'active' ? 'Active' : 'Completed'}')`).addClass(
            'active');
    ...
    function renderCollabs(collabs, status) {
        ...
        collabs.forEach(c => {
            const photo1 = c.photo_1 ? `<img src="../../../${c.photo_1}" alt="Product">` :
                '<i class="fas fa-image placeholder"></i>';
            const photo2 = c.photo_2 ? `<img src="../../../${c.photo_2}" alt="Product">` :
                '<i class="fas fa-image placeholder"></i>';
            const photo3 = c.photo_3 ? `<img src="../../../${c.photo_3}" alt="Product">` :
                '<i class="fas fa-image placeholder"></i>';

            const financialText = c.financial_type === 'paid' ?
                `₹${parseFloat(c.financial_amount).toLocaleString()}` : 'Barter';
