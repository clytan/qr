        ...
        <div class="modal fade" id="exportColumnsModal" tabindex="-1" aria-labelledby="exportColumnsModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="exportColumnsModalLabel">Select Columns to Export</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" id="exportColumnSelectorModal">
                    <!-- JS will dynamically insert checkboxes here -->
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" id="exportSelectedBtnModal">Export Selected</button>
                </div>
                </div>
            </div>
        </div>
